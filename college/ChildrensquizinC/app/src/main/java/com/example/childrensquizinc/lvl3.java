...
public class lvl3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_lvl.setText(R.string.level3);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(lvl3.this,GemeLvl.class );
        ...
        dialog.setContentView(R.layout.priviedialog3);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Intent intent = new Intent(lvl3.this,lvl4.class);
                    startActivity(intent);
                    finish();
  ...
  final Animation a = AnimationUtils.loadAnimation(lvl3.this,R.anim.alpha);

    numLeft = random.nextInt(20);
   img_left.setImageResource(array.imeges3[numLeft]);
   text_left.setText(array.texts3[numLeft]);
   numRight = random.nextInt(20);
   while (array.strong[numLeft]==array.strong[numRight]){
       numRight = random.nextInt(20);
   }
   img_right.setImageResource(array.imeges3[numRight]);
