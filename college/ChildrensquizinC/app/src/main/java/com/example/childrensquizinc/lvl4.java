...
public class lvl4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_lvl.setText(R.string.level4);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(lvl4.this,GemeLvl.class );
        ...
        dialog.setContentView(R.layout.priviedialog4);
        ...
        dialogEnd.setContentView(R.layout.dialogend4);
  ...
  final Animation a = AnimationUtils.loadAnimation(lvl4.this,R.anim.alpha);

    numLeft = random.nextInt(20);
   img_left.setImageResource(array.imeges4[numLeft]);
   text_left.setText(array.texts4[numLeft]);
   numRight = random.nextInt(20);
   while (array.strong[numLeft]==array.strong[numRight]){
       numRight = random.nextInt(20);
   }
   img_right.setImageResource(array.imeges4[numRight]);
