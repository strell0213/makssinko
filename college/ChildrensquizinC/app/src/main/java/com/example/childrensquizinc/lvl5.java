...
public class lvl5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_lvl.setText(R.string.level5);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(lvl5.this,GemeLvl.class );
        ...
        dialog.setContentView(R.layout.priviedialog5);
  ...
  final Animation a = AnimationUtils.loadAnimation(lvl5.this,R.anim.alpha);

    numLeft = random.nextInt(20);
   img_left.setImageResource(array.imeges5[numLeft]);
   text_left.setText(array.texts5[numLeft]);
   numRight = random.nextInt(20);
   while (array.strong[numLeft]==array.strong[numRight]){
       numRight = random.nextInt(20);
   }
   img_right.setImageResource(array.imeges5[numRight]);
